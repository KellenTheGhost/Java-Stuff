...
public class Project1_Parker {
    ...
    /**
     * prompts user to select quiz to take input 1-6
     * if input not 1-6, re-prompt user
     * if 6, exit program and report final progress of correct questions out of attempted
     * if 1-5, do different quizzes
     * uses nested loop to repeat quizzes and have 5 questions per quiz
     * @param args 
     */
